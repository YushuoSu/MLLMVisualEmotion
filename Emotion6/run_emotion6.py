# =============================================================================
# Emotion6 — Batch runner for all models
# =============================================================================
import os
import sys
import subprocess
...
# --- All model scripts for Emotion6 ---
VLLM_SCRIPTS = [
    "qwen2_test.py",
    "qwen2p5_test.py",
    "qwen3_test.py",
...
def main():
    log_message("=" * 50)
    log_message("Emotion6 — Batch evaluation start")
    log_message("=" * 50)
    ...
    log_message("\n" + "=" * 50)
    log_message(f"Emotion6 batch complete: {success} OK, {fail} FAILED")
    if failed_scripts:
