# =============================================================================
# Emotion6 / FaceEmotion — vLLM-based model evaluation (shared runner)
# =============================================================================
# This module is imported by each model-specific script.  The per-model script
# only needs to define MODEL_KEY and (optionally) override TASK_NAMES.
# =============================================================================
import sys
import os
...
# ---------------------------------------------------------------------------
# All seven task types used across Emotion6 and FaceEmotion
# ---------------------------------------------------------------------------
ALL_TASK_NAMES = [
...
def build_task_configs(dataset_name, model_name, task_names=None):
    """Build TASK_CONFIGS list from dataset + model names."""
...
def main_vllm(model_key, dataset_name, task_names=None):
    """Main entry point for a vLLM-based model evaluation script."""
